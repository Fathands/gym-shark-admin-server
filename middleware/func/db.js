...
* @param options
*/
exports.update = (model, conditions, update, options) => {
  return new Promise((resolve, reject) => {
...
exports.remove = (model, conditions) => {
  return new Promise((resolve, reject) => {
...
* @param callback
*/
exports.find = (model, conditions, fields, options = {}) => {
...
exports.findPage = async (model, conditions, fields, options = {}) => {
  var sort = options.sort == undefined ? {
      _id: -1
  } : options.sort;
  delete options.sort;
